...
include("https://streamtest.blob.core.windows.net/styles/streamtestbadge.css", "css");
    ...
    jQuery(document).ready(function () {
        ...
        jQuery("iframe").each(function (index, element) {
            ...
            if (src.indexOf("youtube") != -1 || src.indexOf("vimeo") != -1)
                var button = jQuery(element).after("<a href=//www.streamtest.net/#tester?streamUrl=" + src + " target='_blank'><button class='tabButton'>Test this Stream</button></a>");
        ...
        jQuery("object").each(function (index, element) {
            ...
            if (type === "application/x-shockwave-flash") {
                ...
                if (flashBaseUrlMatches && flashUrlMatches) {
                    ...
                    jQuery(element).after("<a href=//www.streamtest.net/#tester?streamUrl=" + sanitizedUrl + " target='_blank'><button class='tabButton'>Test Stream</button></a>")
                }
            }
        });
    });
